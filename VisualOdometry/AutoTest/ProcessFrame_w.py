...
class HandCodedLaneFollower(object):
    ...
    def steer(self, frame, lane_lines):
        ...
        """
        self.curr_steering_angle = self.compute_steering_angle(frame, lane_lines)
    ...
    def detect_edges(self,frame):
        ...
        #self.show_image("blue mask", mask)
    ...
    def detect_edges_old(self,frame):
        ...
        for i in range(16):
            ...
            upper_blue = np.array([150, 255, 255])
            mask = cv2.inRange(hsv, lower_blue, upper_blue)
            #self.show_image("blue mask Sat=%s" % (16* i), mask)
    ...
    def display_heading_line(self,frame, steering_angle, line_color=(0, 0, 255), line_width=5, ):
        ...
        y2 = int(height / 2)
        # Make it into [Left, Right, Forward] format
        if steering_angle in range(75,125):
            print("Go Forward")
            self.dirc.append('F')
        elif steering_angle > 125:
            print("Turn Right")
            self.dirc.append('R')
        else:
            print('Turn Left')
    ...
    def test_photo(self,file):
        ...
        #self.show_image('final', combo_image, True)
        cv2.waitKey(0)
    ...
    def test_video(self,video_file):
        ...
        try:
            ...
            while cap.isOpened():
                ...
                cv2.imshow("F", combo_image)
                """if i == 30:
                    if self.dirc:
                        max_out = max(self.dirc, key=self.dirc.count) # find the most frequent direction
                        print('AFTER 30 with ',max_out)
                        i = 0
                        self.dirc = []"""
...
if __name__ == '__main__':
    ...
    hcd = HandCodedLaneFollower()
    hcd.test_video('C:/Users/windows 10/Desktop/superP/VisualOdometry/AutoTest/tftt.mp4')
    
    #test_photo('C:/Users/windows 10/Desktop/superP/VisualOdometry/AutoTest/roadimg.jpeg')
    #get_road('C:/Users/windows 10/Desktop/superP/VisualOdometry/AutoTest/roadimg.png')
"""